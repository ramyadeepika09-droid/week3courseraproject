...
```
Peer graded Assignment : Getting and cleaning datacourse project

This repository is a submission for getting and cleaning data course projec. it has the instructions on how to run analysis on human activity recognition dataset.
